...
UPFServerGetUserPublisherReadOnlyData* UPFServerGetUserPublisherReadOnlyData::GetUserPublisherReadOnlyData(UObject* WorldContextObject, class APlayerController* PlayerController , const FString& InPlayFabId, const TArray<FString>& InKeys, const int32& InIfChangedFromDataVersion)
{
...
void UPFServerGetUserPublisherReadOnlyData::OnErrorCallback(const PlayFab::FPlayFabError& InError)
{
	FBPServerGetUserDataResult BPResult;
 	OnFailure.Broadcast(BPResult);	
}
