...
UCLASS()
class PLAYFABPROXY_API UPFClientUnlinkAndroidDeviceID : public UOnlineBlueprintCallProxyBase
{
...
public:
	...
	static UPFClientUnlinkAndroidDeviceID* UnlinkAndroidDeviceID(UObject* WorldContextObject, class APlayerController* PlayerController, const FString& InAndroidDeviceId);
...
private:
	...
	PlayFab::ClientModels::FUnlinkAndroidDeviceIDRequest Request;
