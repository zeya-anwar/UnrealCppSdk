...
public:
	...
	static UPFClientUpdateSharedGroupData* UpdateSharedGroupData(UObject* WorldContextObject, class APlayerController* PlayerController, const FString& InSharedGroupId, const FString& InData);
