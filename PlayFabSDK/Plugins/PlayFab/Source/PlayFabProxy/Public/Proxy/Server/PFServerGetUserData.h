...
UCLASS()
class PLAYFABPROXY_API UPFServerGetUserData : public UOnlineBlueprintCallProxyBase
{
...
public:
	...
	static UPFServerGetUserData* GetUserData(UObject* WorldContextObject, class APlayerController* PlayerController, const FString& InPlayFabId, const TArray<FString>& InKeys, const int32& InIfChangedFromDataVersion);
