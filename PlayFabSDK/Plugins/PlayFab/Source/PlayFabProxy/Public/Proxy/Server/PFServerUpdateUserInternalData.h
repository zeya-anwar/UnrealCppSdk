...
UCLASS()
class PLAYFABPROXY_API UPFServerUpdateUserInternalData : public UOnlineBlueprintCallProxyBase
{
...
public:
	...
	static UPFServerUpdateUserInternalData* UpdateUserInternalData(UObject* WorldContextObject, class APlayerController* PlayerController, const FString& InPlayFabId, const FString& InData, const TArray<FString>& InKeysToRemove);
