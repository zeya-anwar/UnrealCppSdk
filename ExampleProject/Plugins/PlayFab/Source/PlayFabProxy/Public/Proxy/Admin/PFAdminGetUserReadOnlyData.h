...
UCLASS()
class PLAYFABPROXY_API UPFAdminGetUserReadOnlyData : public UOnlineBlueprintCallProxyBase
{
...
public:
	...
	static UPFAdminGetUserReadOnlyData* GetUserReadOnlyData(UObject* WorldContextObject, class APlayerController* PlayerController, const FString& InPlayFabId, const TArray<FString>& InKeys, const int32& InIfChangedFromDataVersion);
