...
#include "PFClientLoginWithXbox.generated.h"

UCLASS()
class PLAYFABPROXY_API UPFClientLoginWithXbox : public UOnlineBlueprintCallProxyBase
{
...
public:
	...
	static UPFClientLoginWithXbox* LoginWithXbox(UObject* WorldContextObject, class APlayerController* PlayerController, const FString& InTitleId, const FString& InXboxToken, const bool& InCreateAccount);
