...
public:
	...
	static UPFClientLoginWithCustomID* LoginWithCustomID(UObject* WorldContextObject, class APlayerController* PlayerController, const FString& InTitleId, const FString& InCustomId, const bool& InCreateAccount);
