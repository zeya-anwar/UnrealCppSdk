...
public:
	...
	static UPFClientGetPlayFabIDsFromSteamIDs* GetPlayFabIDsFromSteamIDs(UObject* WorldContextObject, class APlayerController* PlayerController, const TArray<int32>& InSteamIDs);
