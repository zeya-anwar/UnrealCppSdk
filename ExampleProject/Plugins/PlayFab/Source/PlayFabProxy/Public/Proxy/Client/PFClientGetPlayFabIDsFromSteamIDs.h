...
public:
	...
	static UPFClientGetPlayFabIDsFromSteamIDs* GetPlayFabIDsFromSteamIDs(UObject* WorldContextObject, class APlayerController* PlayerController, const TArray<FString>& InSteamStringIDs);
