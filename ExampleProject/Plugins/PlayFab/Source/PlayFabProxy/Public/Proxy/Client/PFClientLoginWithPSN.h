...
#include "PFClientLoginWithPSN.generated.h"

UCLASS()
class PLAYFABPROXY_API UPFClientLoginWithPSN : public UOnlineBlueprintCallProxyBase
{
...
public:
	...
	static UPFClientLoginWithPSN* LoginWithPSN(UObject* WorldContextObject, class APlayerController* PlayerController, const FString& InTitleId, const FString& InAuthCode, const FString& InRedirectUri, const int32& InIssuerId, const bool& InCreateAccount);
