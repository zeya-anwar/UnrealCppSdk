...
namespace PlayFab
{
	...
	{
	public:
        static TSharedRef<IHttpRequest> PlayFabRequestHandler::SendRequest(const FString& callPath, const FString& callBody, const FString& authKey, const FString& authValue);
