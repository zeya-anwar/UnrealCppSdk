...
namespace ServerModels
{
	...
	struct PLAYFAB_API FGetUserAccountInfoResult : public FPlayFabBaseModel
    {
		...
		// [optional] Account info for the user whose information was requested.
		TSharedPtr<FUserAccountInfo> UserInfo;
	...
	struct PLAYFAB_API FUpdateUserInventoryItemDataRequest : public FPlayFabBaseModel
    {
		...
		TMap<FString, FString> Data;
		// [optional] Optional list of Data-keys to remove from ItemData.  Some SDKs cannot insert null-values into Data due to language constraints.  Use this to delete the keys directly.
		TArray<FString> KeysToRemove;
